...
float scalex_mod = 1.5;
float scaley_mod = 1.5;
float scalez_mod = 1.5;
    ...
    while (!glfwWindowShouldClose(window))
{
        ...
        transformation_matrix = glm::scale(transformation_matrix, glm::vec3(scalex_mod, scaley_mod, scalez_mod));
